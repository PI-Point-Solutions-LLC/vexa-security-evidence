...
| R-003 | Untrusted evidence is treated as safe or authoritative | PR.DS, DE.AE, RS.MI | High | Fail-closed quarantine, immutable scan results, trust-state gates, provenance and investigator review | Mitigating; production validation open |
